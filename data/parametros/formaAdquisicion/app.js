angular.module('vadowApp')	 			
	.controller('formaAdquisicionController', function ($scope, $route, $http) {	
		$scope.$route = $route;

		jQuery(function($) {				
			$("#tabFormaAdquisición").click(function(event) {
		    ...
		    $(window).on('resize.jqGrid', function () {
		        $(grid_selector).jqGrid('setGridWidth', $("#tabFormaAdquisición").width() - 10);
		    });
		    ...
		    jQuery(grid_selector).jqGrid({
		        url: 'data/parametros/formaAdquisicion/appXml.php',
		        autoencode: false,
		        datatype: "xml",
				height: 320,
		        ...
		        editurl: "data/parametros/formaAdquisicion/app.php",		        
		    });
		    ...
		    },
		    {
		        ...
		        afterSubmit: function(response) {
	                ...
	                if(retorno == '1') {
	                	...
	                	if(retorno == '2') {
	                		$("#nombre").val("");
		                	return [false,"Error.. Esta forma de adquisición ya fue agregado"];
		                }
	                }
	                return [true,'',retorno];
	            },
