		...
		jQuery(function($) {				
		    ...
		    jQuery(grid_selector).jqGrid({
				...
				colModel:[
					...
					{name:'estado',index:'estado',width:150, editable:true, hidden: true, editoptions:{size:"20", maxlength:"150"}, editrules: {required: true,edithidden:true},edittype:'checkbox',formatter: "checkbox",editoptions: { value:"Activo:Inactivo"}},
