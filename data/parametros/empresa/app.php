<?php 
	...
	if ($_POST['tipo'] == "Guardar Datos") {		
		...
		if($class->num_rows($sql) > 0) {		
			...
			$sql = "INSERT INTO empresa VALUES ('".$id."','".$_POST['razonSocial']."','".$_POST['nombreComercial']."','".$_POST['direccion']."','".$_POST['ruc']."','".$_POST['email']."','".$_POST['autorizacion']."','".$_POST['obligacion']."','".$_POST['contribuyente']."','".$dirToken."','".$_POST['token']."','".$dirLogo."','0');";
